...
findc
  pulx;Use X register to store the return address
  pula;
  clr result;
  
loop
  pulb;Use B register to store the current checking character in the string.
  cmpb #$0;
  beq reset;If the B is the null character, exit the subroutine.
  cba;
  beq increment;
  bra loop;
